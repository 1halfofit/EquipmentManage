...
<body>
	...
	<a href="http://localhost:8080/EquipmentManage/equiServlet?method=findEquipmentList">修改</a>
	<a href="http://localhost:8080/EquipmentManage/equiServlet?method=findEquipmentList">删除</a>
	<a href="http://localhost:8080/EquipmentManage/equiServlet?method=findEquipmentList">列表</a>
	</div>
</body>
</html>